...
<head>
	<title>HMS</title>
	<link rel="shortcut icon" type="image/x-icon" href="../medicose/assets/img/favicon.png" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Medicose</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
        ...
        <!-- role choosing tab on top right corner -->
        ...
        <!-- role choosing tab end -->
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <!-- register as a patient form -->
                    ...
                    <!-- register as a patient form end -->
                                </div>
                            </form>
                            </div>
